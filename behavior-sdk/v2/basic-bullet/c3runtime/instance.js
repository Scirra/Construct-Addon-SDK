...
C3.Behaviors.SDKSample_BasicBullet.Instance = class BasicBulletBehaviorInstance extends globalThis.ISDKBehaviorInstanceBase
{
	constructor()
	{
		super();
		...
		if (properties)
		{
			...
			this._isStopOnSolid = properties[1];
			this._isEnabled = properties[2];
		}
	...
	_getDebuggerProperties()
	{
		...
		return [{
			...
			properties: [
				{name: prefix + ".properties.speed.name",		value: this.speed,		onedit: v => this.speed = v },
