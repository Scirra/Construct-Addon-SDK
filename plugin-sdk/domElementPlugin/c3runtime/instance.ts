...
class MyDOMInstance extends globalThis.ISDKDOMInstanceBase
{
	...
	constructor()
	{
		...
		if (properties)
		{
			this._text = properties[0] as string;
		}
...
C3.Plugins.MyCompany_DOMPlugin.Instance = MyDOMInstance;

export type { MyDOMInstance as SDKInstanceClass };